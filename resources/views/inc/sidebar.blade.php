              ...
              <ul class="sidebar-menu">
                  ...
                  <li>
                      <a href="{{ route('category.index') }}">
                          <i class="fa fa-th"></i> <span>Category</span> <small
                ...
                <li>
                  ...
                  <li class="treeview">
                      ...
                      <ul class="treeview-menu">
                          <li><a href="{{ asset('pages/layout/top-nav.html') }}"><i class="fa fa-circle-o"></i> Top
                                  Navigation</a></li>
                          <li><a href="{{ asset('pages/layout/boxed.html') }}"><i class="fa fa-circle-o"></i>
                                  Boxed</a></li>
                          <li><a href="{{ asset('pages/layout/fixed.html') }}"><i class="fa fa-circle-o"></i>
                                  Fixed</a></li>
                          <li><a href="{{ asset('pages/layout/collapsed-sidebar.html') }}"><i
